...
public class Main extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jComboBox1.equals("Escolha um dos personagens...")&&(jComboBox2.equals("Escolha um dos jogos..."))){
            ...
            + "||Player: " + listape.get(i).getPlayer()+ "||Id_personagem: " + listape.get(i).getId())){
                    ...
                    pd.inserirJogo(listaj.get(a).getCodjogo(), listape.get(i).getId());
    ...
    public void CarregarLista(){
        ...
        for(int i=0;i<lista.size();i++){
            ...
            + "||Player: " + lista.get(i).getPlayer() + "||Id_personagem: " + lista.get(i).getId());
        }
    }
