...
public class PersonagemDAO {
    ...
    public List <Personagem> listaDePersonagem(){
        try {
            String SQL="SELECT skill, sexo, inteligencia, mana, forca, ataque1, ataque2, player, id_personagem   FROM thaleszd.personagem";
    ...
    private Personagem pegaDados(ResultSet resultado){
        try {
            ...
            atual.setId(resultado.getInt("id_personagem"));
            return atual;
        } catch (SQLException ex) {
            Logger.getLogger(PersonagemDAO.class.getName()).log(Level.SEVERE, null, ex);
        }
